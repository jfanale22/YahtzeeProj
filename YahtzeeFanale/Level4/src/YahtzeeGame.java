...
public class YahtzeeGame
{
	...
	*/
	...
	private void markScore()
	{
		...
		switch (placement){
			case 1: sc.markOnes(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue()); break;
			case 2: sc.markTwos(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 3: sc.markThrees(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 4: sc.markFours(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 5: sc.markFives(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 6: sc.markSixes(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 7: sc.markThreeOfAKind(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 8: sc.markFourOfAKind(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 9: sc.markFullHouse(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 10: sc.markSmallStraight(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 11: sc.markLargeStraight(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 12: sc.markYahtzee(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 13: sc.markChance(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
		}
